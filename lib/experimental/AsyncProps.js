...
var RouteComponentWrapper = (0, _createReactClass2.default)({
  ...
  render: function render() {
    var _props = this.props,
        ...
        routerState = _props.routerState;
    var _context$asyncProps = this.context.asyncProps,
        componentsArray = _context$asyncProps.componentsArray,
        propsArray = _context$asyncProps.propsArray,
...
var AsyncProps = (0, _createReactClass2.default)({
  ...
  render: function render() {
    ...
    var _state = this.state,
        asyncProps = _state.asyncProps,
        previousProps = _state.previousProps;
